...
{% if site.links.resume and site.links.resume != "" %}<a href="{{ site.links.resume | prepend: '/' | relative_url }}" class="icon-link" title="Resume" aria-label="Resume">{% include icon.html name="cv" %}</a>{% endif %}
